...
{
    // Define clamped joint anlges and assign them to the requested ones
    float clamped_j1 = requested_j1;
    float clamped_j2 = requested_j2;

    //Get min and max joint parameters, and assigning them to their respective variable
    ...
    n2.getParam(node_name + "/max_joint_1_angle", max_j2);
    n2.getParam(node_name + "/min_joint_2_angle", min_j1);
